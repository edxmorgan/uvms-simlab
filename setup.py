...
setup(
    ...
    data_files=[
        ...
        *dynamics_profile_data_files(),
        ...
        ('lib/' + package_name, [package_name+'/sim_camera_renderer.py']),
        ('lib/' + package_name, [package_name+'/opencv_camera_viewer.py']),
        ('lib/' + package_name, [package_name+'/replay_session_plotter.py']),
        ('lib/' + package_name, [package_name+'/replay_plot_node.py']),
    ],
    ...
    zip_safe=True,
    maintainer='Edward Morgan',
    maintainer_email='edmorgangh@gmail.com',
    description='UVMS SimLab interactive control, planning, replay, recording, and visualization tools.',
